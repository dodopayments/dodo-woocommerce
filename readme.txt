...
* Feature: send customers who abandon the hosted checkout back to your store. By default the order is cancelled and its items are restored to the cart; you can instead keep the order alive on the order pay page, send a URL of your choosing, or send nothing at all. Previously no cancel URL was sent and customers were left with no route back.
